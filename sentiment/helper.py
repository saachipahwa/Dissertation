...
def get_before_lockdown():
    ...
    before_second_lockdown.to_csv("sentiment/nurses_csvs/before_second_lockdown.csv")
    ...
    before_third_lockdown.to_csv("sentiment/nurses_csvs/before_third_lockdown.csv")
