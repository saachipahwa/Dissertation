...
def second_filter(followers_df_name = "data/filteredNEUfollowers.csv", directory = 'teachertweets'):
...
def third_filter(followers_df_name = "data/filteredNUJfollowers.csv", directory = "journalisttweets"):
