...
# remove_empty_tweets()
df = pd.read_csv("data/healthcare_tweets.csv")
df['text'].replace('', np.nan, inplace=True)
df.dropna(subset=['text'], inplace=True)
...
#     df = pd.read_csv("data/healthcare_tweets.py")
#     #remove RT's
#     df = df[df['text'].str.startswith('RT ')==True]
#
#     #remove empty tweets
...
#
#     #remove punctuation
#     df['clean_text'] = df['cleantext'].apply(lambda x:remove_punctuation_string(x))
#
#     #lower case
...
#
#
#     df.to_csv("data/healthcare_tweets.py")