...
print("model 10 score", metric.score({"topics":get_words_from_model(model_10)}))

model_15 = BERTopic.load("topics/models/nursetweets_15_model")
print("doing evaluation for", "15")
print("model 15 score", metric.score({"topics":get_words_from_model(model_15)}))

model_20 =  BERTopic.load("topics/models/nursetweets_20_model")
print("doing evaluation for", "20")
print("model 20 score", metric.score({"topics":get_words_from_model(model_20)}))
